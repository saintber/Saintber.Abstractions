namespace Saintber.Abstractions.Repository
{
    ...
    public interface IGetRepository<TDataModel, TDataFilter>
    {
        /// <summary>
        ...
        Task<IReadOnlyList<TDataModel>> GetAsync(TDataFilter filter, CancellationToken cancellationToken = default);
    }
}
