namespace Saintber.Abstractions.Repository
{
    ...
    public interface IUpdateRepository<TUpdateDataModel> : IUpdateRepository<string, TUpdateDataModel> { }
    ...
    public interface IUpdateRepository<TDataResult, TUpdateDataModel>
    {
        ...
        Task<IEnumerable<TDataResult>> UpdateAsync(IEnumerable<TUpdateDataModel> updates, CancellationToken cancellationToken = default);
    }
}
